...
import com.example.findfare.R;

public class Findfare extends Activity implements OnItemClickListener {
	...
	public static final float DISTANCE_CONSTANT = 0.005f;
	public static final float DURATION_CONSTANT = 0.001f;
	...
	private class CalcDistTask extends AsyncTask<URL, Integer, Integer[]>{
		...
		protected void onPostExecute(Integer[] results){
			distanceEditText.setText(texts[0]);
			durationEditText.setText(texts[1]);
			costEditText.setText("Rs " + String.format("%.2f", DISTANCE_CONSTANT*results[0] 
